...
class Calculator:
    ...
    def create_operator_buttons(self):
        ...
        for operator, symbol in self.operations.items():
            button=tk.Button(self.button_frame, text=symbol, bg=OFFWHITE, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE,
    ...
    def create_clear_button(self):
            button=tk.Button(self.button_frame, text="C", bg=OFFWHITE, fg=LABEL_COLOR, font=DEFAULT_FONT_STYLE,
